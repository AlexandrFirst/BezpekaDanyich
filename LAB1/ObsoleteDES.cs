...
namespace LAB1
{
    public class ObsoleteDES : IDES
    {
        ...
        private string[][] keyForRounds = null;
        private int[][] entropiaPerRound = null;

        public string[] GetkeyForRounds
        {
            get
            {
                if (keyForRounds == null) { return new string[0]; }
                return keyForRounds[0];
            }
        }
        public int[][] GetEntropiaPerRound
        {
            get
            {
                if (entropiaPerRound == null) { return new int[0][]; }

                return entropiaPerRound;
            }
        }
        ...
        //Heart of DES  
        private void SixteenRounds(int blockNum)
        {
            int n;
        ...
        //DES Components  
        private void StartEncryption(int blockNum)
        {
